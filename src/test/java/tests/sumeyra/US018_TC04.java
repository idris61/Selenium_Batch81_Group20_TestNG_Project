...
public class US018_TC04 extends TestBaseRapor {
    SumeyraPage sumeyraPage = new SumeyraPage();
    Actions actions = new Actions(Driver.getDriver());
    @Test
    public void test() {
        extentTest = extentReports.createTest("US018_TC04", "Tipi ve sebebi aciklanmali");
        ...
        //Type ve reason görünürlüğü test edilir.
        for (WebElement each : sumeyraPage.refundTypeReason
        ) {
            Assert.assertTrue(each.isDisplayed());
        }
        extentTest.pass(" Type ve reason görünürlüğü test edildi.");
    }
}