...
public class US018_TC02 extends TestBaseRapor {
    SumeyraPage sumeyraPage = new SumeyraPage();
    Actions actions = new Actions(Driver.getDriver());
    @Test
    public void test() {
        extentTest = extentReports.createTest("US018_TC02", "Order ID: verilen urun numarası belli edilmeli");
        ...
        //OrderID görünürlüğü test edilir.
        Assert.assertTrue(sumeyraPage.refundOrderId.isDisplayed());
        extentTest.pass("OrderID görünürlüğü test edildi");
    }
}