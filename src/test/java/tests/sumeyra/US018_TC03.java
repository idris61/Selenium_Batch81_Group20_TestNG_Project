...
public class US018_TC03 extends TestBaseRapor {
    SumeyraPage sumeyraPage = new SumeyraPage();
    Actions actions = new Actions(Driver.getDriver());
    @Test
    public void test() {
        extentTest = extentReports.createTest("US018_TC03", "Ne kadar urun alindigi belli edilmeli");
        ...
        //Amaunt görünürlüğü test edilir.
        Assert.assertTrue(sumeyraPage.refundAmount.isDisplayed());
        extentTest.pass("Amaunt görünürlüğü test edildi.");
    }
}