...
public class US014_TC01 extends TestBaseRapor {
    @Test
    public void test() throws InterruptedException, IOException {
        extentTest=extentReports.createTest("US014_TC01", "Minimum spend / en az alma miktari girilmeli");
        ...
        // "Minimum spend" bolümüne tıklanarak değer girilir
        actions.sendKeys(Keys.PAGE_DOWN).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ARROW_DOWN).perform();

        Assert.assertTrue(page.minimumSpend.isEnabled());
        extentTest.info("Minimum spend bölümünün erisilebilir oldugu dogrulandı");

        page.minimumSpend.sendKeys("50");
        extentTest.pass("Minimum spend bolümüne değer girildi");
        Thread.sleep(1000);

        ReusableMethods.getScreenshot("US014_TC01");
    }
}
