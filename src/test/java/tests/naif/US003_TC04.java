...
public class US003_TC04 {
    ...
    public void testTC04() throws InterruptedException {
        ...
        naifPage.firstname.sendKeys(ConfigReader.getProperty("Firstname"));
        actions.sendKeys(Keys.TAB).sendKeys(ConfigReader.getProperty("Lastname")).sendKeys().perform();
