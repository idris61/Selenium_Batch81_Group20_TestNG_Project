...
public class US003_TC05 extends TestBaseRapor {
    @Test
    public void testTC05() throws InterruptedException, IOException {
        ...
        extentTest=extentReports.createTest("Billing bilgileri tam olarak eklenmeli ve place order diyerek order yapılmalı");
        ...
        jse.executeScript("arguments[0].click();", naifPage.placeorder);
        Assert.assertTrue(naifPage.thenkyou.isDisplayed());
        Thread.sleep(2000);
        extentTest.pass("Thank you. Your order has been received.");
        ReusableMethods.getScreenshot("US003-TC05");
