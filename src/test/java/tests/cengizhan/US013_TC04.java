...
public class US013_TC04 extends TestBaseRapor {
    ...
    @Test
    public void Test_US013_TC04() throws Exception {
        extentTest=extentReports.createTest("US013_TC04", "Store manager olarak kupon olusturabilme - Coupon amount olmalı");
        ...
        wait.until(ExceptedCondition.visibilityOf(page.couponAmountWE));

        //"Add Coupon" sayfasında "Coupon Amount" kutucugunun Enabled oldugu dogrulanır
        Assert.assertTrue(page.couponAmountWE.isEnabled());
        extentTest.info("Add Coupon sayfasında 'Coupon Amount' kutucugunun Enabled oldugu dogrulandı");
        ReusableMethods.getScreenshot("US013_TC04");
        Driver.closeDriver();
    }
}
