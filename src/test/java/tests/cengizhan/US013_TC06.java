...
public class US013_TC06 extends TestBaseRapor {
    ...
    @Test
    public void Test_US013_TC06() throws Exception {
        extentTest=extentReports.createTest("US013_TC06", "Store manager olarak kupon olusturabilme - Free shipping uygulanmalı");
        ...
        wait.until(ExceptedCondition.visibilityOf(page.freeShippingWE));

        //"Add Coupon" sayfasında "Allow free shipping" kutucugunun Enabled oldugu dogrulanır
        Assert.assertTrue(page.freeShippingWE.isEnabled());
        extentTest.info("Add Coupon sayfasında 'Allow free shipping' kutucugunun Enabled oldugu dogrulandı");
        ReusableMethods.getScreenshot("US013_TC06");
        Driver.closeDriver();
    }
}
