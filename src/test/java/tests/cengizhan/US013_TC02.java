...
public class US013_TC02 extends TestBaseRapor {
    ...
    @Test
    public void Test_US013_TC02() throws Exception {
        extentTest=extentReports.createTest("US013_TC02", "Store manager olarak kupon olusturabilme - Tanimlama yazılmalı");
        ...
        wait.until(ExceptedCondition.visibilityOf(page.descriptionWE));

        //"Add Coupon" sayfasında "Description" kutucugunun Enabled oldugu dogrulanır
        Assert.assertTrue(page.descriptionWE.isEnabled());
        extentTest.info("Add Coupon sayfasında 'Description' kutucugunun Enabled oldugu dogrulandı");
        ReusableMethods.getScreenshot("US013_TC02");
        Driver.closeDriver();
    }
}
