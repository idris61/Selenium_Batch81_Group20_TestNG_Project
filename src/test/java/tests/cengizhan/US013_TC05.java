...
public class US013_TC05 extends TestBaseRapor {
    ...
    public void Test_US013_TC05() throws Exception {
        extentTest=extentReports.createTest("US013_TC05", "Store manager olarak kupon olusturabilme - Coupon expiry date olmalı");
        ...
        extentTest.info("Add Coupon sayfasında 'Coupon expiry date' kutucugunun Enabled oldugu dogrulandı");
        ReusableMethods.getScreenshot("US013_TC05");
        Driver.closeDriver();
    }
}
