...
public class US013_TC01 extends TestBaseRapor {
    ...
    @Test
    public void Test_US013_TC01() throws InterruptedException, IOException {
    extentTest=extentReports.createTest("US013_TC01", "Store manager olarak kupon olusturabilme - Coupon kodu verilebilmeli");
       ...
       //"Add Coupon" sayfasında "Code" kutucugunun Enabled oldugu dogrulanır
        ...
        extentTest.info("Add Coupon sayfasında 'Code' kutucugunun Enabled oldugu dogrulandı");
        ReusableMethods.getScreenshot("US013_TC01");
        Driver.closeDriver();
    }
}
