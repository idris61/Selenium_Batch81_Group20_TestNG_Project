...
public class US019_TC02 extends TestBaseRapor {
    @Test
    public void test02() throws InterruptedException {
        extentTest=extentReports.createTest("US019_TC02","Islemleri tanımlanmalı");
        ...
        extentTest.pass("Action görünürlüğü test edildi");
